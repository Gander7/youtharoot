...
Tests for endpoints:
- GET /api/youth/{youth_id}/parents - List parents for a youth
- POST /api/youth/{youth_id}/parents - Add parent to youth  
- DELETE /api/youth/{youth_id}/parents/{parent_id} - Remove parent from youth
- GET /api/parents/{parent_id}/youth - List youth for a parent
"""
...
def sample_youth_and_parent(client, clear_person_store):
    ...
    parent_response = client.post("/api/parent", json=parent_data)
...
class TestParentYouthRelationshipAPI:
    ...
    def test_add_parent_to_youth(self, client, sample_youth_and_parent):
        ...
        response = client.post(f"/api/youth/{youth_id}/parents", json=relationship_data)
        assert response.status_code == 200
    ...
    def test_get_youth_parents_after_adding(self, client, sample_youth_and_parent):
        ...
        client.post(f"/api/youth/{youth_id}/parents", json=relationship_data)
        
        # Get parents for youth
        response = client.get(f"/api/youth/{youth_id}/parents")
        assert response.status_code == 200
    ...
    def test_prevent_duplicate_parent_youth_relationship(self, client, sample_youth_and_parent):
        ...
        response1 = client.post(f"/api/youth/{youth_id}/parents", json=relationship_data)
        assert response1.status_code == 200
        
        # Try to add same parent again - should return error
        response2 = client.post(f"/api/youth/{youth_id}/parents", json=relationship_data)
    ...
    def test_remove_parent_from_youth(self, client, sample_youth_and_parent):
        ...
        response = client.delete(f"/api/youth/{youth_id}/parents/{parent_id}")
        assert response.status_code == 200
        
        # Verify parent is removed
        parents_response = client.get(f"/api/youth/{youth_id}/parents")
    ...
    def test_get_youth_for_parent(self, client, sample_youth_and_parent):
        ...
        response = client.get(f"/api/parents/{parent_id}/youth")
        assert response.status_code == 200
    ...
    def test_add_parent_with_invalid_youth_returns_404(self, client, sample_youth_and_parent):
        ...
        response = client.post("/api/youth/99999/parents", json=relationship_data)
        assert response.status_code == 404
...
class TestParentYouthRelationshipValidation:
    ...
    def test_only_parents_can_be_linked_to_youth(self, client, sample_youth_and_parent):
        ...
        leader_response = client.post("/api/persons", json=leader_data)
